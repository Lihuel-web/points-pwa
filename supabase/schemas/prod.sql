...
\restrict 8asgWVs2bzEpwDhT43ZEqgDxqs3pi0TzhbkLNJ2OafQFfi8Xjae54sKV8wNjYx5
...
--
-- Name: award_points(text, integer, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.award_points(_identifier text, _delta integer, _reason text, _device_id text) RETURNS json
    LANGUAGE plpgsql SECURITY DEFINER
...
--
-- Name: award_points_by_student(bigint, integer, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.award_points_by_student(_student_id bigint, _delta integer, _reason text, _device_id text) RETURNS json
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
declare
...
--
-- Name: delete_student(bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.delete_student(_student_id bigint) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
declare
...
--
-- Name: game_local_team_leaderboard(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.game_local_team_leaderboard(_limit integer DEFAULT 50) RETURNS TABLE(local_team_id integer, local_team_name text, pool_team_id integer, pool_team_name text, team_best integer, best_student_name text)
...
--
-- Name: game_local_team_leaderboard_road(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.game_local_team_leaderboard_road(_limit integer DEFAULT 50) RETURNS TABLE(local_team_id integer, local_team_name text, pool_team_id integer, pool_team_name text, team_best integer, best_student_name text)
    LANGUAGE sql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
with best_per_student as (
...
--
-- Name: game_local_team_leaderboard_snake(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.game_local_team_leaderboard_snake(_limit integer DEFAULT 50) RETURNS TABLE(local_team_id integer, local_team_name text, pool_team_id integer, pool_team_name text, team_best integer, best_student_name text)
    LANGUAGE sql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
with best_per_student as (
...
--
-- Name: game_local_team_leaderboard_tetris(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.game_local_team_leaderboard_tetris(_limit integer DEFAULT 50) RETURNS TABLE(local_team_id integer, local_team_name text, pool_team_id integer, pool_team_name text, team_best integer, best_student_name text)
    LANGUAGE sql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
with best_per_student as (
...
--
-- Name: get_my_local_total(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_my_local_total() RETURNS TABLE(pool_team_id integer, local_team_id integer, pool_points integer, spent integer, total_local integer)
    LANGUAGE sql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
  with me as (
...
--
-- Name: reset_all_points(boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.reset_all_points(include_game_scores boolean DEFAULT false) RETURNS json
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
declare
...
--
-- Name: reset_game_scores(text[]); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.reset_game_scores(games text[] DEFAULT ARRAY['flappy'::text, 'snake'::text, 'tetris'::text, 'road'::text]) RETURNS json
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
declare
...
--
-- Name: student_can_read_team(uuid, bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.student_can_read_team(_uid uuid, _team_id bigint) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
declare
...
--
-- Name: team_local_spend_adjust(integer, integer, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.team_local_spend_adjust(_local_team_id integer, _amount integer, _reason text DEFAULT NULL::text, _device_id text DEFAULT 'web-teacher'::text) RETURNS json
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
declare
...
--
-- Name: team_pool_adjust(integer, integer, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.team_pool_adjust(_pool_team_id integer, _delta integer, _reason text DEFAULT NULL::text, _device_id text DEFAULT 'web-teacher'::text) RETURNS json
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
declare
...
--
-- Name: top_local_leaderboard(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.top_local_leaderboard(_limit integer DEFAULT 9) RETURNS TABLE(local_team_id integer, pool_team_id integer, local_name text, pool_name text, spent integer, pool_points integer, total_local integer)
    LANGUAGE sql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
  with base as (
...
--
-- Name: balances; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.balances WITH (security_invoker='on') AS
 SELECT student_id,
...
--
-- Name: game_local_best; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.game_local_best AS
...
--
-- Name: game_scores_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: game_scores_archive; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: game_scores_road; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.game_scores_road (
    id bigint NOT NULL,
    user_id uuid NOT NULL,
    student_id bigint NOT NULL,
    student_name text NOT NULL,
...
--
-- Name: game_scores_road_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.game_scores_road_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: game_scores_road_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: game_scores_road_archive; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.game_scores_road_archive (
...
--
-- Name: game_scores_snake; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.game_scores_snake (
    id bigint NOT NULL,
    user_id uuid NOT NULL,
    student_id bigint NOT NULL,
    student_name text NOT NULL,
...
--
-- Name: game_scores_snake_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.game_scores_snake_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: game_scores_snake_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: game_scores_snake_archive; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.game_scores_snake_archive (
...
--
-- Name: game_scores_tetris; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.game_scores_tetris (
    id bigint NOT NULL,
    user_id uuid NOT NULL,
    student_id bigint NOT NULL,
    student_name text NOT NULL,
...
--
-- Name: game_scores_tetris_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.game_scores_tetris_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: game_scores_tetris_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: game_scores_tetris_archive; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.game_scores_tetris_archive (
...
--
-- Name: team_balances; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.team_balances WITH (security_invoker='on') AS
 SELECT tm.team_id,
...
--
-- Name: team_pool_tx; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.team_pool_tx (
    id bigint NOT NULL,
...
--
-- Name: team_local_spend; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.team_local_spend WITH (security_invoker='on') AS
 SELECT local_team_id,
...
--
-- Name: team_pool_balances; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.team_pool_balances WITH (security_invoker='on') AS
 SELECT pool_team_id,
    COALESCE(sum(delta), (0)::bigint) AS points
   FROM public.team_pool_tx
  WHERE (COALESCE(tx_type, 'earn'::text) <> 'spend'::text)
...
--
-- Name: team_local_remaining; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.team_local_remaining WITH (security_invoker='on') AS
...
--
-- Name: team_member_points; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.team_member_points WITH (security_invoker='on') AS
 SELECT tm.team_id,
    s.id AS student_id,
    s.name,
    s.class,
...
--
-- Name: team_pool_earned; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.team_pool_earned WITH (security_invoker='on') AS
 SELECT pool_team_id,
    COALESCE(sum(
        CASE
...
--
-- Name: team_pool_tx_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.team_pool_tx_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: team_pool_tx_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: team_pool_tx_archive; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.team_pool_tx_archive (
...
--
-- Name: transactions_archive; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: game_scores id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_road id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_snake id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_tetris id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: team_pool_tx id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: cards cards_card_token_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cards cards_card_uid_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_archive game_scores_archive_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_road_archive game_scores_road_archive_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_road game_scores_road_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_snake_archive game_scores_snake_archive_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_snake game_scores_snake_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_tetris_archive game_scores_tetris_archive_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_tetris game_scores_tetris_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: team_pool_tx_archive team_pool_tx_archive_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: team_pool_tx team_pool_tx_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: teams teams_parent_scope_chk; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: teams teams_scope_allowed_chk; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: transactions_archive transactions_archive_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_road_archive_local_team_id_score_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: game_scores_road_archive_student_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: game_scores_snake_archive_local_team_id_score_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: game_scores_snake_archive_student_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: game_scores_tetris_archive_local_team_id_score_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: game_scores_tetris_archive_student_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cards_uid; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_gs_road_local_score; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_gs_road_student; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_gs_snake_local_score; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_gs_snake_student; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_gs_tetris_local_score; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_gs_tetris_student; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_students_class_name; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_teams_parent_scope; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_transactions_student_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: transactions_archive_created_at_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: transactions_archive_student_id_created_at_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: transactions_archive_student_id_created_at_idx1; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: uq_cards_card_uid; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: uq_students_auth_user_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: messages_2025_09_06_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2025_09_07_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2025_09_08_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2025_09_06_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2025_09_07_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: messages_2025_09_08_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: -
--
...
--
-- Name: admin_actions admin_actions_actor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cards cards_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cards cards_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_scores game_scores_local_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_road game_scores_road_local_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_road game_scores_road_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_road game_scores_road_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_snake game_scores_snake_local_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_snake game_scores_snake_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_snake game_scores_snake_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_scores game_scores_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_tetris game_scores_tetris_local_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_tetris game_scores_tetris_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: game_scores_tetris game_scores_tetris_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: team_pool_tx team_pool_tx_local_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: team_pool_tx team_pool_tx_pool_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: teams teams_parent_global_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: transactions transactions_teacher_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cards Students can view their cards; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: transactions Students can view their transactions; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: bridge_status; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: cards cards: teacher can insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cards cards: teacher can select all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cards cards: teacher can update; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: game_scores flappy: insert own run; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: game_scores flappy: select same local; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: game_scores game: insert own run; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: game_scores game: select same local; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: game_scores_road; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.game_scores_road ENABLE ROW LEVEL SECURITY;

--
-- Name: game_scores_snake; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.game_scores_snake ENABLE ROW LEVEL SECURITY;

--
-- Name: game_scores_tetris; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.game_scores_tetris ENABLE ROW LEVEL SECURITY;

--
-- Name: profiles profile: self can read; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: profiles profiles: read self; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: game_scores_road road: insert own run; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: game_scores_road road: select same local; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: game_scores_snake snake: insert own run; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: game_scores_snake snake: select same local; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: teams student: read all globals; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: team_members student: read own membership; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: transactions student: read own tx; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: students student: read self; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: teams student: read via fn; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: students students: teacher can insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: students students: teacher can select all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: bridge_status teacher rw bridge_status; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: teams teacher: all teams; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: students teacher: delete students; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: team_members teacher: delete team_members; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: students teacher: insert students; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: team_members teacher: insert team_members; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: transactions teacher: insert tx; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: admin_actions teacher: read admin_actions; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cards teacher: read cards; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: team_pool_tx_archive teacher: read pool_archive; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: students teacher: read students; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: team_members teacher: read team_members; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: transactions teacher: read tx; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: transactions_archive teacher: read tx_archive; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cards teacher: update cards; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: students teacher: update students; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cards teacher: upsert cards; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: team_pool_tx_archive; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: game_scores_tetris tetris: insert own run; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: game_scores_tetris tetris: select same local; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: transactions transactions: teacher can select all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: transactions_archive; Type: ROW SECURITY; Schema: public; Owner: -
--
